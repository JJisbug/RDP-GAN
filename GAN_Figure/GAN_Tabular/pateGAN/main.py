"""
This code is to generate DP-guaranteed tabular data, which is modified from https://github.com/carpedm20/DCGAN-tensorflow.
...
flags.DEFINE_string("noise_style", "loss", \
                    "para: Noise std for differential privacy added on parameters of discriminator;\
                    loss: Noise std for differential privacy added on the loss of discriminator")
flags.DEFINE_float("sigma", 0, "Noise std for differential privacy")
flags.DEFINE_float("noise_bound", 10, "Noise bound")
flags.DEFINE_float("para_bound", 1e6, "Parameter bound")
flags.DEFINE_float("num_saver", 10, "Save the model")
