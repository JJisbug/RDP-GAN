...
def generate_data(sess, model, config, num_epoch, option):
    ...
    if option == 1:
        ...
        rsf_out.to_csv(f'{save_dir}/{config.dataset}_{config.noise_style}_std{config.sigma}_epoch{num_epoch}_fake.csv' , index=False, sep=',')
